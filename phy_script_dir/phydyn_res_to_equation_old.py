...
def read_write_init_values_file(init_values_file_name, par_init_values_dict, step_list, multiple_range):
            ...
            for line in init_values_line_list:
                ...
                if StartValuesOfparameters == True and StartValuesOfequations == False:                           
                    ...
                    if '_initval' in raw_name and str(step) + '_' + par_name in par_init_values_dict:                                      
                        ...
                        out_eq_init_values_file.write(raw_name + '=' + \
                                                      str(par_init_values_dict[str(step) + '_' + par_name]*float(multiple_range)) + \
                                                      '\n')   
...
par_names_list = read_write_init_values_file(args.equations, par_init_values_dict, step_list, args.multiple_range)
